...
FLOAT | 4 | (-3.402823466E+38， <br /> -1.175494351E-38)，0，(1.175494351E-38， <br /> 3.402823466351E+38) | 0，(1.175494351E-38， <br /> 3.402 823466E+38) | 单精度浮点数值 <br /> (计算可能有偏差)
...
DECIMAL(M,D) | 字节:(对DECIMAL(M,D) ，如果M>D，为M+2否则为D+2) 依赖于M和D的值(M 最大 65, 默认 10) | | 小数值,定点计算
